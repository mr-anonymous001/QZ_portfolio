        ...
        <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-6 sm:mt-8">
              ...
              <Link href="/aml-compliance" className="bg-beige/60 rounded-lg p-4 sm:p-6 shadow-md border-2 border-olive/20 hover:border-olive hover:bg-olive hover:text-beige transition-all duration-300 cursor-pointer group">
